<%@ Page Title="" Language="C#" MasterPageFile="~/principal.Master" AutoEventWireup="true" CodeBehind="EditarMesa.aspx.cs" Inherits="ProyectoRestaurante.EditarMesa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid divRedondear" style="background-color:white">
        <div class="col-md-offset-1 col-md-10">
            ...
            <center><h2>Modulo de Edición de Mesas</h2></center>
        ...
        <div class="form-group row">
            <div class="col-md-4">
                <label runat="server" style="font-size:large" id="lblNumero" for="">Número de Mesa</label>
            </div>
            <div class="col-md-8">
                 <asp:TextBox ID="txtNumero" Font-Size="Large" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="registrar" ControlToValidate="txtNumero" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="El campo número es requerido"></asp:RequiredFieldValidator>
            </div>
         </div>
