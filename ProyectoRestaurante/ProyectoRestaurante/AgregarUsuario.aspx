<%@ Page Title="" Language="C#" MasterPageFile="~/principal.Master" AutoEventWireup="true" CodeBehind="AgregarUsuario.aspx.cs" Inherits="ProyectoRestaurante.AgregarUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="container-fluid divRedondear" style="background-color:white">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
                 <asp:TextBox ID="txtIdentificación" Font-Size="Large" runat="server" CssClass="form-control"></asp:TextBox>
        ...
        <div class="col-md-8">
        <asp:DropDownList ID="ddlRol" CssClass="form-control" Font-Size="Large" runat="server" ></asp:DropDownList>
         </div>
        </div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ValidationGroup="registrar" ControlToValidate="txtTelefono" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="El campo telefono es requerido"></asp:RequiredFieldValidator>
               ...
               <div class="form-group row">
            <div class="col-md-4">
                <label runat="server" style="font-size:large" id="Label1" for="">Contraseña</label>
            </div>
            <div class="col-md-8">
                 <asp:TextBox ID="txtPassword" Font-Size="Large" runat="server" CssClass="form-control" ReadOnly="true" ></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="registrar" ControlToValidate="txtPassword" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="El campo contraseña es requerido"></asp:RequiredFieldValidator>
            </div>
         </div>
       ...
       <div class="form-group row">
        ...
        <asp:DropDownList ID="ddlEstado" CssClass="form-control" Font-Size="Large" runat="server" ></asp:DropDownList>
            ...
            <asp:Button ID="btnAceptar" ValidationGroup="registrar" OnClientClick="if(Page_ClientValidate())return confirm('¿Desea Guardar los cambios?');"  runat="server" Text="Guardar" CssClass="btn btn-success" OnClick="btnAceptar_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
