<%@ Page Title="" Language="C#" MasterPageFile="~/principal.Master" AutoEventWireup="true" CodeBehind="EditarProducto.aspx.cs" Inherits="ProyectoRestaurante.EditarProducto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="container-fluid divRedondear" style="background-color:white">
        ...
        <div class="col-md-offset-1 col-md-10">
            ...
            <center><h2>Modulo de Edición de Productos</h2></center>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="registrar" ControlToValidate="txtDescripcion" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="El campo Identificación es requerido"></asp:RequiredFieldValidator>
            </div>
         </div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="registrar" ControlToValidate="txtPrecio" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="El campo nombre es requerido"></asp:RequiredFieldValidator>
            </div>
         </div>
